...
(function ($) {
  ...
  Drupal.behaviors.mediaBluebillywigBrowser = {
    attach: function (context, settings) {
      // Container for the files that get passed back to the browser.
      var files = {};

      // Disable the links in table cells, on media items list.
      $('div#media-browser-library-list td a').click(function () {
        return false;
      });

      // Catch the click on a media item.
      $('#media-bluebillywig-add .media-item').bind('click', function () {
